...
void PrinterGlut::setMessage(const std::string& message)
{
    msg = message;
}

void PrinterGlut::showMessage(std::string message, Level& level, bool waitKey)
{
    if (message == "") return;
...
void PrinterGlut::removeMessage()
{
    msg = "";
...
void PrinterGlut::print(Level& level)
{
    cursorHome();
    cout << endl;
